export default async function handler(req, res) {
  ...
  try {
    ...
    // Bubble 1.4 – zewnętrzne API (działało wcześniej)
    if (model === "bubble1") {
      ...
      const groqResponse = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "Jesteś Bubble 2.1 – zaawansowanym asystentem AI. Odpowiadasz po polsku, używasz markdown.",
            },
